...
public class DashboardController {
    ...
    public String showDashboard(Principal principal, Model model) {
        ...
        if (logs.isEmpty()) {
            logs.add(new CirculationLogDto("The Greatman is a fallback for no data  Gatsby", "Robert Downey", "M-402",
                    "Issued", LocalDate.now().minusDays(2), "On Loan"));
            logs.add(new CirculationLogDto("Introduction to Algorithms", "Sarah Jenkins", "M-115", "Returned", null,
                    "In Library"));
        }
